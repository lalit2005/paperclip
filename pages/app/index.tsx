    ...
    <DashboardLayout>
      <div>
        <div>
          ...
          <Link href='/app/notes'>
            <div className='flex px-10 mt-3 transition-all duration-300 border border-gray-300 rounded cursor-pointer py-7 hover:border-gray-400 hover:bg-gray-50/30'>
              {data?.notes.map((note) => (
